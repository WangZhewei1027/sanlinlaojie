...
const SCALE: {
  ...
  },
  {
    variant: "bodyXs",
    size: "12px / 0.75rem",
    usage: "组件级微文本（badge / 时间戳 / 表格备注），禁止承载完整句子",
  },
];
    ...
    <div className="space-y-8">
      <StorySection title="字体栈 — i18n 的第一决策">
        <div className="w-full space-y-4">
          ...
          <Text as="p" variant="bodyMd">
            中西混排示例：三林老街 Sanlin Old Street — 数字 0123456789
            与标点「引号」（括号）。
          </Text>
        </div>
      </StorySection>
      ...
      <StorySection title="Tone / fontWeight / truncate">
        <div className="w-full space-y-3">
          ...
          <Text as="p" variant="bodyMd" tone="subdued">
            tone=&quot;subdued&quot; — 辅助信息、次要说明
          </Text>
          <Text as="p" variant="bodyMd" tone="critical">
            tone=&quot;critical&quot; — 错误与不可逆警告
          </Text>
          <Text as="p" variant="bodyMd" tone="success">
            tone=&quot;success&quot; — 成功、已完成状态
          </Text>
          <Text as="p" variant="bodyMd" tone="warning">
            tone=&quot;warning&quot; — 警示、需注意状态
          </Text>
          <Text as="p" variant="bodyMd" fontWeight="semibold">
            fontWeight=&quot;semibold&quot; — 覆盖 variant 默认字重
          </Text>
          <Text as="p" variant="bodyMd" truncate className="max-w-64">
            truncate —
            超出容器宽度时截断并显示省略号，截断必须显式，禁止静默溢出。
          </Text>
        </div>
      </StorySection>
